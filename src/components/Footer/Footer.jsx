                ...
                <div className="footerInfo">
                    <div className="footerAdd d-flex align-items-center w-75">
                        ...
                        <div className="addText">
                            <p className="mb-0 fw-bold fs-5 addtxt1">RentVerse</p>
                            <p className="text-muted mb-0 addtxt2">MBH, National Institute of Technology, Jalandhar</p>
                        </div>
                    </div>
                    <div className="addOpen mt-4 d-flex align-items-center w-75">
                        ...
                        <div className="addText">
                            <a href='mailto:rentinggo1@gmail.com' className="mb-0 fw-bold fs-5 addtxt1 nav-link">rentverse@gmail.com</a>
                        </div>
                    </div>
                    <div className="addCall mt-4 d-flex align-items-center w-75">
                        ...
                        <div className="addText">
                            <a className="mb-0 fw-bold fs-5 addtxt1 nav-link" href="tel:+91 07738736881">7837902845</a>
                        </div>
                    </div>
                </div>
